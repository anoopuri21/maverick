...
@section('meta_description', $page->seo['meta_description'] ?? 'Explore our pathway programs — global bachelors, dual degrees, master\'s and doctoral pathways.')
    ...
    <section class="gpw-list">
        <div class="container">
            <div class="sec-head">
                ...
                <h2 class="d">{{ $page->title ?? 'Pathway Programs' }}</h2>
            </div>
