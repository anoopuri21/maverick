...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('mba_masters_hero.eyebrow', 'Online MBA & Master\'s · GCC');
        $this->migrator->add('mba_masters_hero.headline', 'Affordable Online MBA & Master\'s Programs in GCC');
        ...
        $this->migrator->add('mba_masters_trust.label', 'Trusted by learners across the GCC & beyond');
        ...
        $this->migrator->add('mba_masters_seo.meta_title', 'Online MBA & Master\'s in GCC | Maverick Business Academy London');
        $this->migrator->add('mba_masters_seo.meta_description', 'Affordable Online MBA & Master\'s programs in GCC for working professionals. Flexible study, 1-year routes, scholarships & university partners. Enquire today.');
        $this->migrator->add('mba_masters_seo.meta_keywords', 'Online MBA GCC, Online MBA in Dubai, Online MBA in GCC fees, Master degree in GCC online, MBA in GCC for working professionals');
