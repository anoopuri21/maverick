# Program Detail Page Content · Rushford Master's Programmes (21)

Master record for the Rushford programme-page content series. Structure per `landing-page/program-detail/01-...md` and the live demo design. Voice per `landing-page/ai-team/prompts/content-writer-agent-prompt.md` + G02 §8.

Common facts (Rushford official listing): 16 months online, 27 courses of ~3 weeks, 90 ECTS, capstone. Excluded sections on every page: recognition, accreditation, university block, success stories, reviews, network, faculty voice, FAQ, enquire, CTA.

| # | File | Programme | Status |
|---|------|-----------|--------|
| 01 | 01-mba-logistics-supply-chain-management-rushford-content.md | MBA in Logistics & Supply Chain Management | DONE (v4 humanized) |
| 02 | 02-mba-in-sustainability-energy-and-environment-rushford-content.md | MBA in Sustainability, Energy and Environment | DONE |
