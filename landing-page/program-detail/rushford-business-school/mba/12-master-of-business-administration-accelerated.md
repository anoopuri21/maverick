...
### meta_description
Accelerated 12-month online MBA from Rushford Business School, Switzerland. 60 ECTS, 15 courses, self-paced study, AED instalments. Enquire now.
...
**01 · Done in a year**
Fifteen courses across twelve months. For people who need the credential before the next appraisal cycle, the maths is the pitch.
...
Flexible learning | Fully self-paced study, twelve to fifteen hours a week, with all materials on the portal
...
Twelve months is the shortest route to a Swiss MBA on this site, for people whose promotion window will not wait sixteen of them.
...
### request block
Fees depend on the intake and study arrangements, so no fixed figure sits here. Admissions sends a personal breakdown on request, free and without obligation. Across our Master's programmes, totals usually land between AED 16,000 and 40,000.
