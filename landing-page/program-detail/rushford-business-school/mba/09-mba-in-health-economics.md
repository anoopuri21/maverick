...
**Sources on file:** official Rushford program page (16 months, 90 ECTS, career paths), UAE national health insurance mandate (MOHRE)
...
### meta_title
MBA in Health Economics Online | Rushford | Maverick

### meta_description
16-month online MBA in Health Economics from Rushford Business School. 90 ECTS, case-based study, AED installments. Enquire now.
...
### short_description
Someone has to answer the question every health system avoids: what is this treatment worth? This 16-month online MBA from Rushford Business School trains the economist behind that answer, and you study it from the UAE while still working.
...
### note
Each intake carries its own fees and dates, issued in writing before any payment. Get the written version before you decide; webpages change, agreements should not.
...
The format works for people already inside healthcare, which most of the cohort will be. Courses run in three-week blocks in the evenings, assessments mirror the analyzes health organizations actually commission, and the capstone can be built around a payer, a provider, or a policy question from your own context.

---

## 4. WHY CHOOSE THIS PROGRAM (benefits)

**01 · A rare credential, taught online**
...
Monthly AED payments without interest, scheduled against salary dates and agreed in writing.

**06 · Local support throughout**
One success coach for the degree, and advisors in Sharjah available in person or on WhatsApp.

Closing line: The certificate is issued by Rushford Business School, Switzerland. Where you aim it, payer, provider, or policy, is the interesting part.

---

## 5. LEARNING OUTCOMES (learning)

01 Judge the cost-effectiveness of treatments and technologies with method
02 Model how health systems get funded, and where the money leaks
03 Analyze health markets the way an economist would, with data
04 Price and evaluate insurance products inside a mandated market
05 Read policy proposals for their economic consequences
06 Handle the statistics health economics actually uses
07 Present economic arguments to clinicians and executives alike
08 Deliver a capstone on a live health economics question
...
Medical Device Pricing Analyst
...
- Capstone Project on a live health economics challenge
...
Assignment support | Feedback on economic analyzes and policy briefs, not formatting
Affordable installments | Interest-free AED monthly payments, set out in writing
Career guidance | Advisors familiar with payer, pharma, and policy hiring in the Gulf
Documentation assistance | Enrollment worked through with you, step by step
...
Registration Fee | Shown in the full structure before any payment
...
Offer Validity | Early-bird pricing shifts with each intake, so confirm the window

### request block
Fees vary with intake and study mode, so we print no fixed figure in advance. Admissions sends a personal breakdown on request, free of charge and obligation. Across our Master's programs, totals usually land between AED 16,000 and 40,000.
...
- Sources: Rushford official program page, rushford.ch (16 months online, 90 ECTS, case-study and simulation approach; official career paths: health economist roles in pharma/biotech/medtech, consulting and research, government and policy agencies, non-profits and international development, health insurance and managed care, academia, hospitals, venture capital and private equity); mandatory policies 86.22% share); UAE national health insurance mandate effective 1 Jan 2025 (MOHRE).
