...
05 Run strategic case analysis until the pattern recognition kicks in
06 Tie innovation to growth instead of treating them as separate conversations
07 Approach mergers and acquisitions with structure, not instinct
08 Deliver a capstone that a leadership team can act on
...
### intro
Four stages. Two to build breadth, one to think like a strategist, one to prove it on a live brief.
...
- Capstone Project on a live strategic question
