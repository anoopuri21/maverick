# 01 · Program Detail Page Content: BSc in Psychology (v5)

**Page:** /programs/bsc-psychology
**Awarding university:** Girne American University, North Cyprus
**Category:** BSc · **Level:** Bachelor's · **Duration:** confirmed per approved academic pathway and entry route
...
**Sources on file:** client BSc Psychology source document (curriculum, careers, assessment, focus areas), Ken Research UAE mental health market (2026), Bonafide Research UAE mental wellness overview, approved bachelors landing page
...
**04 · Strong research skills**
How to design research, analyse information, and evaluate psychological evidence critically, which is the discipline's core skill.

**05 · Transferable professional skills**
Communication, analytical thinking, research, and interpersonal skills that apply across many industries, from HR to marketing.

**06 · Study around your career**
Flexible learning allows working professionals to continue their education while managing professional and personal commitments.

Closing line: Girne American University awards the degree. What you do with the understanding afterwards, in HR rooms, classrooms, clinics, or your own research, is where it counts.
...
**Years 1 and 2 · Business and management foundations**
...
- Cognitive, developmental, social, biological, and personality psychology, mental health, organisational psychology, research methods, psychological assessment, counselling foundations, behavioural science, and human development
...
### gcc_heading
Why GCC students and professionals choose this BSc

### cards

**01 · The mental health field is growing fast**
The UAE mental health market is valued at USD 1.5 billion in 2025 and projected to reach USD 2.7 billion by 2031, a 12% CAGR, per Ken Research, and the sector reports a shortage of qualified professionals.

**02 · Psychology knowledge crosses industries**
HR, education, healthcare, business, marketing, customer experience, training, social services: the degree applies across all of them.

**03 · Multicultural workplaces are the local context**
Professionals across the GCC work with teams representing different cultures, languages, and backgrounds, and psychological understanding supports stronger communication and workplace relationships.
...
### request block
Fee structures vary with the intake, approved entry pathway, and available scholarship opportunities. Speak with the admissions team for a personalised breakdown based on your academic profile, preferred intake, and study pathway. No commitment required.

---

## BUILD NOTES (internal, not page copy)

- Built from the client source document "BSc in Pyschology - GAU.docx" (filename typo in source). Curriculum focus areas, learning outcomes (10), career areas (20), assessment types, and the licensing caveat all taken from it.
- PROOF FIX: source specialization module "Clynical psychology" corrected to "Clinical Psychology"; module capitalisation normalised. Confirm with client.
- PROOF FIX: source Year 1 / Year 2 blocks mixed the standard business foundation modules with the psychology modules and repeated some lines (copy-paste artefact); page presents the business foundations as Years 1-2 and the psychology modules as the specialization. Confirm sequencing with the university.
- Duration is deliberately not fixed: source states "subject to the approved academic pathway and entry route". Kept that wording; flag if a standard duration should appear.
- Excluded per client section list: Student Success Stories, Our Network, Faculty Voice, FAQ, Enquire form, final CTA.
- GCC market data: Ken Research UAE mental health market (USD 1.5B 2025 to USD 2.7B 2031, 12% CAGR); Bonafide Research note on specialist-to-patient ratio below international standards. Softenable if legal wants.
- Cross-reference to GAU MSc in Counselling Psychology is accurate for this catalogue.
- Sign-off needed: exact fee per intake, scholarship rules, intake dates, module sequencing confirmation, licensing-caveat wording approval.
