...
## 1. External fact-check (S2 / S7)
| # | Claim (where used) | Source cited | Re-verified [date] | Status |
|---|---|---|---|---|
| F1 | | | | PASS / FAIL / guarded |

Notes: single-source facts kept/dropped, with reason.

## 2. Consistency matrix
| Check | Result |
|---|---|
| Brief ↔ research ↔ keywords ↔ claims ↔ blueprint | ✅ / ❌ + note |
| Regulation framing = R-pack | |
| Personas ↔ keywords ↔ routes ↔ sections | |
| Durations: one per family | |
| Placeholders confined to tracked blanks | |

## 3. Sweeps (output kept)
...
- Read-aloud test: [attested] · Counsellor-desk test: [attested]
- Facts changed by humanizer: none (claims map identical since Gate 4)

## 5. Issues log
| # | Severity | Issue | Fix | Owner | Location |
|---|---|---|---|---|---|
| 1 | P0/P1/P2 | | | | |

## 6. Gate status & verdict
| Gate | Status |
|---|---|
