...
`program-detail/` · Program detail page content packs (field-mapped to the `Program` model):

| File | What it is |
|---|---|
| `program-detail/01-mba-logistics-supply-chain-management-rushford-content.md` | MBA in Logistics & Supply Chain Management (Rushford): hero, glance, overview, why, learning, careers, structure, support, GCC reasons, fees, SEO; excluded sections per client list left empty; sources on file |
