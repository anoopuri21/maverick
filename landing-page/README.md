...
| `gulf-masters/12-masters-programs-list-university-wise.pdf` | **PROGRAMS LIST (PDF):** university → master's category → master's programs, all 50 master's programs from `uploads/listing.pdf` + approved UWS addition (generated by `scripts/gen_masters_programs_list_pdf.py`) |
