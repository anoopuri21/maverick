...
| `gulf-masters/08-masters-landing-content-gcc-uae.md` | **THE PAGE CONTENT** (v2, client cap 3,000–3,500 words: 3,111): 18 sections, overview lists per client themes (community/networking, ASK Quotient, skills- and knowledge-based learning, case studies), 12 FAQ AEO answers, zero placeholders, zero em dashes, all 15 keywords placed |
