...
> **Status:** IMPLEMENTATION (steps 1-4/6 done — audit + merge + migrate + cutover; tests need PHP+vendor to run) — decisions locked: scope = ALL assets, videos = EXCLUDED. Execution 1-by-1 phases me hogi.
