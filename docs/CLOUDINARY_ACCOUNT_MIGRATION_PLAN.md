...
> **Status:** IMPLEMENTATION (steps 1-3/6 done — audit + merge + migrate; tests need PHP+vendor to run) — decisions locked: scope = ALL assets, videos = EXCLUDED. Execution 1-by-1 phases me hogi.
