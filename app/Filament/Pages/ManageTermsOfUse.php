...
class ManageTermsOfUse extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.pages.manage-terms-of-use';
    ...
    {
        $this->form->fill([
            'content' => app(TermsPageSettings::class)->toArray(),
            'seo' => app(TermsSeoSettings::class)->toArray(),
        ]);
    }
                    ...
                    ->tabs([
                        Tab::make('Hero')
                            ...
                            ->schema([
                                ...
                                MediaPicker::forField('content.background_image', 'terms/hero')
                        ...
                        Tab::make('Content')
                            ...
                            ->schema([
                                MediaPicker::forField('content.center_image', 'terms/center')
                                    ->label('Center Image')
                                    ->columnSpanFull(),
    ...
    public function save(): void
    {
        try {
            ...
            $this->saveSettingsGroup(TermsPageSettings::class, $content);
            $this->saveSettingsGroup(TermsSeoSettings::class, $seo);

            Notification::make()
                ->title('Terms of Use saved')
                ->success()
                ->send();
            ...
            Notification::make()
                ->title('Could not save Terms of Use')
                ->danger()
                ->send();
        }
    }
