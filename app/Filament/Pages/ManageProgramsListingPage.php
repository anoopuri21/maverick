...
class ManageProgramsListingPage extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Programs Listing Page';
    protected static ?int $navigationSort = 1;
    protected static string $view = 'filament.pages.manage-programs-listing-page';
    ...
    {
        $this->form->fill([
            'hero' => app(ProgramsListingPageSettings::class)->toArray(),
            'seo' => app(ProgramsListingSeoSettings::class)->toArray(),
        ]);
    }
    ...
    public function form(Form $form): Form
    {
        return $form
            ->statePath('data')
            ->schema([
                Tabs::make('Programs Listing Page')
                    ->tabs([
                        Tab::make('Hero')
                            ->icon('heroicon-o-photo')
                            ->schema([
                                Section::make()
                                    ->description('Programs are managed under Programs → Programs')
                                    ->schema([
                                        ...
                                        MediaPicker::forField('hero.hero_background_image', 'programs/hero')
                    ...
                    ->columnSpanFull(),
                        ...
                        Tab::make('Labels')
                            ->icon('heroicon-o-tag')
                            ->schema([
                                TextInput::make('hero.cta_label')->label('Program Card CTA Label'),
                                TextInput::make('hero.empty_message')->label('Empty State Message'),
                                TextInput::make('hero.card_cta_label')->label('Learn More Button Text'),
                            ]),
                        ...
                        Tab::make('SEO')
                            ...
                            ->schema([
                                ...
                                MediaPicker::forField('seo.og_image_url', 'programs/seo')->label('OG Image'),
                                Grid::make(2)->schema([
                                ...
                                MediaPicker::forField('seo.twitter_image_url', 'programs/seo')->label('Twitter Image'),
    ...
    public function save(): void
    {
        try {
            ...
            $this->saveSettingsGroup(ProgramsListingPageSettings::class, $hero);
            $this->saveSettingsGroup(ProgramsListingSeoSettings::class, $seo);

            Notification::make()
                ->title('Programs Listing Page saved')
                ->success()
                ->send();
            ...
            Notification::make()
                ->title('Could not save Programs Listing Page')
                ->danger()
                ->send();
        }
    }
