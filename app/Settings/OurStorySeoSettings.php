...
/**
 * SEO metadata for the static "Our Story" page.
 * Mirrors the SeoMetadata model field names so the shared
 * partials/seo-meta.blade.php can render these tags directly.
 */
class OurStorySeoSettings extends Settings
{
