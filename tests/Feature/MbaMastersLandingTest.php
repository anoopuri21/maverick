...
class MbaMastersLandingTest extends TestCase
{
    ...
    public function test_landing_page_renders_hero_and_trust(): void
    {
        ...
        $response->assertSee('Degrees for the UAE and GCC', false);
        ...
        $response->assertSee('4.9/5', false);
        $response->assertSee('Rajesh Menon', false);
        $response->assertSee('Rated 4.9 out of 5 on Trustpilot', false);
        $response->assertSee('No visa. No relocation', false);
        $response->assertSee('Send me the programme guide', false);
        ...
        $response->assertSee('How to start: five steps', false);
        $response->assertSee('id="mlp-journey"', false);
        $response->assertSee('MBA specializations in UAE: Pick Your MBA', false);
        ...
        $response->assertSee('MBA Fees in UAE: What You Actually Pay');
        ...
        $this->assertSame(6, substr_count($response->getContent(), 'class="pricing-card"'));
        $response->assertSee('pricing-cards__blocks', false);
        $response->assertSee('A flexible payment plan, in AED', false);
        ...
        $response->assertSee('built for the GCC', false);
        $response->assertSee('Your classmates: UAE and GCC professionals', false);
        ...
        $response->assertSee('Your Master&#039;s starts with one conversation', false);
    ...
    public function test_masters_settings_class_resolves_with_trending_defaults(): void
    {
        ...
        $this->assertCount(3, $masters['trending']);
